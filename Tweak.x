...
%end
  ...
  - (void)setText:(NSString *)text {
    ...
    if (changeBatteryText == false) {
      if (changeCarrierText == false) {
        %orig(text);
      }
    }
    }
...
void preferencesChanged() {
    ...
    hideLibraryBlur= (prefs && [prefs objectForKey:@"HideLibraryBlur"] ? [[prefs valueForKey:@"HideLibraryBlur"] boolValue] : YES );
